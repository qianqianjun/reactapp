...
export default class App extends Component{
    ...
    componentDidMount()
    {
        fetch("https://qianqianjun.github.io/api.json")
    ...
    render(){
        ...
        <View style={styles.container}>
            <Text style={styles.title}>Github Friend List</Text>
            <FlatList
                style={styles.list}
                data={this.state.users}
                ListFooterComponent={<Text style={styles.footer}>到底了，别扯了……</Text>}
